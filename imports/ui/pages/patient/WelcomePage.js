  ...
  render() {
    ...
    return (
      <div className="page-content page-content-welcome-page">
        ...
        <div className='section'>
          <Input name='trackedItems' type='checkbox' label='Symptoms' value='symptoms' defaultChecked={this.state.trackedItems.includes('symptoms')} labelClassName={this.state.trackedItems.includes('symptoms') && 'black-text'} disabled='disabled' />
          <Input name='trackedItems' type='checkbox' label='Treatments' value='treatments' defaultChecked={this.state.trackedItems.includes('treatments')} labelClassName={this.state.trackedItems.includes('treatments') && 'black-text'} onChange={this.toggleTrackedItem.bind(this)} />
          <Input name='trackedItems' type='checkbox' label='Notable Events' value='notable events' defaultChecked={this.state.trackedItems.includes('notable events')} labelClassName={this.state.trackedItems.includes('notable events') && 'black-text'} onChange={this.toggleTrackedItem.bind(this)}/>
        </div>
        <div className='section'></div>
        <div className='section'>
          <Button
