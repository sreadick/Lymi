    ...
    return (
      <div>
        ...
        <div className="landing__section landing__section--main">
          ...
          {/* <object type='image/svg+xml' data='/images/landing_graph1.svg' className='abcd'></object> */}
          {/* <svg
            xmlns="http://www.lymelog.com/2000/svg"
            viewBox='0 0 100 100'
            preserveAspectRatio='xMaxYMid'
            style={{position: 'absolute', width: '100%', height: '100%'}}>
            <image href='/images/landing_graph1.svg' className='landing__background-svg' />
          </svg> */}
          ...
          <div className="landing__section--main__flex-wrapper">
            ...
            <div className='row'>
              <Link className="landing__button z-depth-4" to="/signup">Get Started For Free</Link>
            </div>
          </div>
        ...
        {/* <ScrollableAnchor id={'feature-summary'}> */}
          <div className='landing__section--feature-item__row'>
            <div className="landing__section--feature-item">
              ...
              <h5 className='landing__section--feature-item__caption'>Select Your Symptoms and Treatments</h5>
            ...
            <div className="landing__section--feature-item">
              ...
              <h5 className='landing__section--feature-item__caption'>Track Your Progress</h5>
              <p className='landing__section--feature-item__description'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
