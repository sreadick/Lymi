...
class Landing extends React.Component {
  ...
  //   const navAnchorOne = document.querySelector('div.landing__section__scroll-button__wrapper--main');
      ...
      <div>
        ...
        <div className="landing__section landing__section--main--doctor">
          ...
          <div className="landing__section--main__flex-wrapper">
            ...
            <div className='row'>
              <Link className="landing__button landing__button--doctor" to="/signup">Get Started</Link>
            </div>
          </div>
