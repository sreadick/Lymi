...
import ConfirmDeleteModal from '/imports/ui/components/ConfirmDeleteModal';
  ...
  showSelectedSymptoms() {
    return this.props.userSymptoms.map((symptom) => {
      return (
        ...
        <li className="collection-item user-symptom" key={symptom._id}>
          <div>
...
export default createContainer(() => {
  ...
  return {
    ...
    commonSymptoms,
    showConfirmDeleteModal: Session.get('showConfirmDeleteModal') || false,
